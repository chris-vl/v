...
#ifndef VCOIN_TEST_SCRIPTNUM10_H
#define VCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from VCoin Core 0.10.0, for cross-comparison.
 */
public:
