...
const char * const VCOIN_CONF_FILENAME = "vcoin.conf";
const char * const VCOIN_PID_FILENAME = "vcoind.pid";
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", VCOIN_CONF_FILENAME));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", VCOIN_PID_FILENAME));
