...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), VCOIN_CONF_FILENAME));
    if (mode == HMM_VCOIND)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), VCOIN_PID_FILENAME));
#endif
...
/** Sanity checks
 *  Ensure that VCoin is running in a usable environment with all
