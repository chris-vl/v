/* src/config/vcoin-config.h.  Generated from vcoin-config.h.in by configure.  */
/* src/config/vcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VCOIN_CONFIG_H

#define VCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/vcoin/vcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VCoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vcoin"
