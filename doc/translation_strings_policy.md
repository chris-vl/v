...
This document provides guidelines for internationalization of the VCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vcoin_en.ts` remains unchanged.
