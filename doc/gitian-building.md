...
git clone https://github.com/vcoin/vcoin
```
...
Output from `gbuild` will look something like
    ...
    From https://github.com/vcoin/vcoin
...
./bin/gbuild --commit vcoin=${COMMIT} --url vcoin=${URL} ../vcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit vcoin=${COMMIT} --url vcoin=${URL} ../vcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit vcoin=${COMMIT} --url vcoin=${URL} ../vcoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
./bin/gbuild --url vcoin=${BTCPATH},signature=${SIGPATH} ../vcoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[vcoin/gitian.sigs](https://github.com/vcoin/gitian.sigs/) repository, or if that's not possible create a pull
