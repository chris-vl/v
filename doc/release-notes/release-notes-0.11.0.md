VCoin Core version 0.11.0 is now available from:
  ...
  <https://vcoin.org/bin/vcoin-core-0.11.0/>
...
For an example script see [vcoin-submittx](https://github.com/laanwj/vcoin-submittx).
...
- #6116 `30dc3c1` [OSX] rename VCoin-Qt.app to VCoin-Core.app
